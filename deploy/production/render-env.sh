...
: "${RADIO96_DATABASE_PASSWORD_KEY:?RADIO96_DATABASE_PASSWORD_KEY is required}"
...
: "${RADIO96_LIVEKIT_URL_KEY:?RADIO96_LIVEKIT_URL_KEY is required}"
: "${RADIO96_LIVEKIT_API_KEY_KEY:?RADIO96_LIVEKIT_API_KEY_KEY is required}"
: "${RADIO96_LIVEKIT_API_SECRET_KEY:?RADIO96_LIVEKIT_API_SECRET_KEY is required}"
...
database_password=$(lockbox_value "$RADIO96_DATABASE_SECRET_ID" "$RADIO96_DATABASE_PASSWORD_KEY")
livekit_url=$(lockbox_value "$RADIO96_LIVEKIT_SECRET_ID" "$RADIO96_LIVEKIT_URL_KEY")
livekit_api_key=$(lockbox_value "$RADIO96_LIVEKIT_SECRET_ID" "$RADIO96_LIVEKIT_API_KEY_KEY")
livekit_api_secret=$(lockbox_value "$RADIO96_LIVEKIT_SECRET_ID" "$RADIO96_LIVEKIT_API_SECRET_KEY")
